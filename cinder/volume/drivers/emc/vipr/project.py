...
def create_parser(subcommand_parsers, common_parser):
    ...
    create_parser = subcommand_parsers.add_parser('create',
                                description='StorageOS Project Create CLI usage.',
...
def delete_parser(subcommand_parsers, common_parser):
    ...
    delete_parser = subcommand_parsers.add_parser('delete',
                                description='StorageOS Project Delete CLI usage.',
                                parents=[common_parser],
                                conflict_handler='resolve',
...
def show_parser(subcommand_parsers, common_parser):
    show_parser = subcommand_parsers.add_parser('show',
                                description='StorageOS Project Show CLI usage.',
                                parents=[common_parser],
                                conflict_handler='resolve',
...
def list_parser(subcommand_parsers, common_parser):
    list_parser = subcommand_parsers.add_parser('list',
                                description='StorageOS Project List CLI usage.',
                                parents=[common_parser],
                                conflict_handler='resolve',
...
def update_project_parser(subcommand_parsers, common_parser):
    update_project_parser = subcommand_parsers.add_parser('update',
                                description='StorageOS update project CLI usage',
                                parents=[common_parser],
                                conflict_handler='resolve',
                                help='Show project details')
    mandatory_args = update_project_parser.add_argument_group('mandatory arguments')
    mandatory_args.add_argument('-n', '-name',
                                metavar='<name>',
                                dest='name',
...
def update_project(args):
    ...
    try:
        if(not args.tenant):
            args.tenant=""
        obj.update(args.tenant + "/" + args.name,
                   args.newname, args.newowner)
    except SOSError as e:
        raise e
...
def get_acl_parser(subcommand_parsers, common_parser):
    get_acl_parser = subcommand_parsers.add_parser('get-acl',
                                description='StorageOS show project ACL CLI usage.',
                                parents=[common_parser],
                                conflict_handler='resolve',
...
def update_acl_parser(subcommand_parsers, common_parser):
    update_acl_parser = subcommand_parsers.add_parser('update-acl',
                                description='StorageOS update project ACL CLI usage.',
                                parents=[common_parser],
                                conflict_handler='resolve',
                                help='Update project ACL details')
    mandatory_args = update_acl_parser.add_argument_group('mandatory arguments')
    mandatory_args.add_argument('-n', '-name',
                                metavar='<name>',
                                dest='name',
                                help='Name of project',
    ...
    mandatory_args.add_argument('-pe', '-privilege',
                                ...
                                help='privilege',
                                required=True)
    mandatory_args.add_argument('-sub', '-subjectid',
                                metavar="<subjectid>",
                                dest='subjectid',
...
def project_parser(parent_subparser, common_parser):
    ...
    parser = parent_subparser.add_parser('project',
                                description='StorageOS Project CLI usage',
                                parents=[common_parser],
                                conflict_handler='resolve',
