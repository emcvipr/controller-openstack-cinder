...
class BourneInterpreter(cmd.Cmd):
    
    prompt = 'sds_cli> '
    parser = Parser()
    cf = ""
  
    def do_sdscli(self, command):
        #pass
        # Command to be executed
        command = "sdscli " + command
    ...
    def complete_sdscli(self, text, line, begidx, endidx):
